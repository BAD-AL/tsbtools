...
namespace TSBTool2
{
    ...
    public class TSB2Converter
    {
        ...
        public static String ConvertToTSB2FromTSB1(string input)
        {
            ...
            TSBTool.StaticUtils.ShowErrors();
            string retVal = builder.ToString();
            retVal = TSBXSimAutoUpdater.AutoUpdatePlayerSimData(retVal,TSBTool.TSBContentType.TSB2 );
            return retVal;
        }
        ...
        /// <returns></returns>
        internal static string ConvertToTSB2PlayerFromTSB1(string tsb1PlayerLine)
        {
            int simIndex = tsb1PlayerLine.IndexOf("[");
            string simString = "";
            string[] parts =null;
        ...
        public static string TestQbTSB2Conversion()
        {
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultJoe, test);
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultVinny, test);
            return retVal;
        }
        ...
        public static string TestRbTSB2Conversion()
        {
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultThurman, test);
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultRoger, test);
            return retVal;
        }
        ...
        public static string TestDbTSB2Conversion()
        {
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultDeion, test);
            return retVal;
        }
        ...
        public static string TestLbTSB2Conversion()
        {
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultRay, test);
            return retVal;
        }
        ...
        public static string TestDlTSB2Conversion()
        {
            ...
            retVal += TSBTool.StaticUtils.AreEqual(resultTarget, test);
            return retVal;
        }
    ...
    public class TSB1Converter
    {
        public static String ConvertToTSB1FromTSB2(string input)
        {
            ...
            string retVal = TSBTool.TecmonsterTSB1SimAutoUpdater.AutoUpdatePlayerSimData( builder.ToString());
            return retVal;
        }
...
";
    ...
    public class TSB3Converter
    {
        ...
        private static string GetAG(string pos, string ms, string hp)
        {
            ...
            int msIndex = TSBTool.StaticUtils.GetTSBAbility(maxSpeed);
            int hpIndex = TSBTool.StaticUtils.GetTSBAbility(Int32.Parse(hp));
            ...
            switch (pos)
            {
                ...
                case "SS": case "FS": case "DB3":
                    if( msIndex < 0x0E)
                        retval = TSBTool.StaticUtils.MapAbilityToTSBValue(msIndex + 1).ToString();
                    else
                        retval = TSBTool.StaticUtils.MapAbilityToTSBValue(msIndex).ToString();
                    break;
                case "TE1": case "TE2":
                ...
                case "C": case "RG": case "LG": case "RT": case "LT":
                    if (msIndex < 0x0E)
                        retval = TSBTool.StaticUtils.MapAbilityToTSBValue(hpIndex + 2).ToString();
                    else
                        retval = TSBTool.StaticUtils.MapAbilityToTSBValue(hpIndex).ToString();
                    break;
                ...
                case "LCB": case "RCB": case "DB1": case "DB2":
                    if (msIndex < 0x0E)
                        retval = TSBTool.StaticUtils.MapAbilityToTSBValue(msIndex + 2).ToString();
                    else
                        retval = TSBTool.StaticUtils.MapAbilityToTSBValue(msIndex).ToString();
                    break;
                case "K": case "P":
    ...
    public static class TecmoConverter
    {
        ...
        // TSB2->TSB1; TSB2-> TSB3;
        // TSB3->TSB1; TSB3-> TSB2;
        public static string Convert(TSBTool.TSBContentType from, TSBTool.TSBContentType to, string content)
        {
            if( from == to)
                return content;
            string retVal = "";
