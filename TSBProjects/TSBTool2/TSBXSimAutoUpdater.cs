...
namespace TSBTool2
{
    public class TSBXSimAutoUpdater
    {
        ...
        public static string AutoUpdatePlayerSimData(string text, string gameVersion)
        {
            ReloadFormulas();
            if (gameVersion.IndexOf("TSB3") > -1)
        ...
        private static string UpdatePlayerSimValues(string playerLine, string gameVersion)
        {
