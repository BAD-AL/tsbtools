    ...
    public partial class AllstarPlayerControl : UserControl, IAllStarPlayerControl
    {
        ...
        protected virtual void OnPlayerPositionChanged()
        {
            switch (mPlayerPosition)
            {
                ...
                case TSBPlayer.LE2: case TSBPlayer.NT2: case TSBPlayer.RE2:
                    mLegalPositions = new String[] { "LE", "NT", "RE", "LE2", "NT2", "RE2" };
                    break;
                case TSBPlayer.LOLB: case TSBPlayer.LILB: case TSBPlayer.RILB:
                case TSBPlayer.ROLB: case TSBPlayer.LB5:
                    mLegalPositions = new String[] { "LOLB", "LILB", "RILB","ROLB", "LB5" };
                    break;
                case TSBPlayer.LCB: case TSBPlayer.RCB:
                case TSBPlayer.SS: case TSBPlayer.FS: 
                case TSBPlayer.DB1: case TSBPlayer.DB2: case TSBPlayer.DB3:
                    mLegalPositions = new String[] { "LCB", "RCB", "SS", "FS", "DB1", "DB2", "DB3", };
                    break;
                case TSBPlayer.K:
                    mLegalPositions = new String[] {"K"};
                    break;
                case TSBPlayer.P:
                    mLegalPositions = new String[] { "P"};
                    break;
            }
            mUpdating = true;
        ...
        private void PopulateTeamPosComboBox()
        {
            ...
            if (TSB2Tool.teams.Count == 28)
            {
                ...
                for (int i = begin; i < end; i++)
                {
                    ...
                    {
                        mTeamPosComboBox.Items.Add(TSB2Tool.teams[i] + " " + mLegalPositions[j]);
                    }
                }
            }
            else
        ...
        private void OnConferenceChanged()
        {
            ...
            if (TSB2Tool.teams.Count == 28)
            {
                ...
                for (int i = begin; i < end; i++)
                {
                    mTeamComboBox.Items.Add(TSB2Tool.teams[i]);
                }
