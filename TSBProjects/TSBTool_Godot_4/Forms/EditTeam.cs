...
public partial class EditTeam : Control
{
	...
	public override void _Ready()
	{
		...
		m_TeamsComboBox.ItemSelected += M_TeamsComboBox_ItemSelected;
		closeButton.Pressed += CloseButton_Pressed;

		m_SimOffenseUpDown.ValueChanged += SimValueChanged;
		m_SimDefenseUpDown.ValueChanged += SimValueChanged;
		m_OffensivePrefomComboBox.ItemSelected += M_OffensivePrefomComboBox_ItemSelected;
		m_FormationComboBox.ItemSelected += M_FormationComboBox_ItemSelected;
	}
